...
const TweetButton = styled(Button, { name: 'tweet-button' })(({ theme }) => ({
	[theme.breakpoints.up('sx')]: {
		...
		lineHeight: '20px',
		'&:hover': {
			backgroundColor: 'rgb(23, 129, 194)'
		}
	}
}));
const LeftbarForDesktop = () => {
	...
	return (
		<Box className='side-navbar-desktop' sx={{ width: '275px', top: 0, position: 'fixed' }}>
			<Box
...
export default LeftbarForDesktop;
